...
class SCOREBusinessLogic:
    ...
    def invoke_will(self, log_func, id, params: dict, block=None):
    ...
    def invoke_inhe(self, log_func, id, params: dict, block=None):
    ...
    def deleteData(self, log_func, id, params: dict, block=None):
